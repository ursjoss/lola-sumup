...
|HOMEBREW_TAP_TOKEN | Personal Access Token (PAT) in Resource jococo-ch/homebrew-atp with repo scope | PAT | release.yml
|RELEASE_PLZ_TOKEN | Personal Access Token (PAT) in Resource jococo-ch, repository access to this repo and Read & Write permissions for Contents and PRs | PAT | release-plz-pr.yml and release-plz.yml
|===
