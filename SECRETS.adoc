...
|RELEASE_PLZ_TOKEN | Personal Access Token (PAT) in Resource jococo-ch, repository access to this repo and Read & Write permissions for Contents and PRs | release-plz-pr.yml and release-plz.yml
|===
