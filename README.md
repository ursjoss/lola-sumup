...
- Gross values consumption, Tips and total reported values by payment method:
  - `Gross Cash`: Total Gross Income Cash [`MiTi_Cash` + `Cafe_Cash` + `Verm_Cash` + `Deposit_Cash`]
  - `Tips_Cash`: Tips Cash
  - `SumUp Cash`: Total Income Cash [`Gross Cash` + `Tips_Cash`]
  - `Gross Card`: Gross Gross Income Card [`MiTi_Card` + `Cafe_Card` + `Verm_Card` + `Deposit_Card`]
  - `Tips_Card`: Tips Card
...
- Card related payments: Gross values, commission and net values by topic:
  ...
  - `Gross Card LoLa`: Gross Card Income LoLa (Café and Vermietungen) [`Cafe_Card` + `Verm_Card` + `Deposit_Card`]
  ...
  - `Total Commission`: Card Commission Total (MiTi, Café, Vermietungen) [`MiTi_Commission` + `LoLa_Commission` + `Deposit Commission`]
...
- `68450/10920`:  Commission for Café, Vermietung, and Deposit, i.e. w/o Mittagstisch [`Commission LoLa`]
...
- for `10920`: abs(`10920/30200` + `10920/30700` + `10920/23050` + `10920/20051` + `10920/10910` - `Payment SumUp` - `68450/10920`) < 0.02
