...
pub fn gather_df_accounting(df_det: &DataFrame) -> PolarsResult<DataFrame> {
    df_det
        ...
        .select([
            ...
            col(Posting::PAIDOUT_CASH.column_name).alias(Posting::PAIDOUT_CASH.alias),
            col(Posting::PAIDOUT_CARD.column_name).alias(Posting::PAIDOUT_CARD.alias),
            col(Posting::PAIDOUT_TOTAL.column_name).alias(Posting::PAIDOUT_TOTAL.alias),
...
mod tests {
    ...
    use crate::test_fixtures::{
        accounting_df_03, accounting_df_06, accounting_df_08, details_df_03, details_df_06,
        details_df_08,
    };
    ...
    #[rstest]
    fn test_gather_df_accounting08(details_df_08: DataFrame, accounting_df_08: DataFrame) {
        let out =
            gather_df_accounting(&details_df_08).expect("should be able to collect accounting_df");
        assert_dataframe(&out, &accounting_df_08);
    }
    ...
    #[case(
        ...
        500.0, 400.0, 0.0, 100.0, 100.0, 189.25, 1.0, 17.99, 2.00, 0.0, 148.76, 42.49, None, ""
    )]
    // still valid, as we accept a deviation of 0.05/-0.05
    #[case(
        1334.26, 552.0, 1162.0, 0.0, 0.0, 10.0, 20.0, 0.0, 0.0, 0.0, 19.98, 12.0, 20.0, 10.0,
        100.0, 500.0, 400.0, 0.0, 100.0, 100.0, 189.25, 1.0, 17.99, 2.00, 0.0, 148.76, 42.49, None,
        ""
    )]
    #[case(
    ...
    #[case(
        ...
        100.01, 500.0, 400.0, 0.0, 100.0, 100.0, 189.25, 1.0, 17.99, 2.00, 0.0, 148.76, 42.49,
        None, ""
    )]
    #[case(
    ...
    #[case(
        1334.26, 552.0, 1162.0, 0.0, 0.0, 10.0, 20.0, 0.0, 0.0, 0.0, 20.0, 12.0, 20.0, 10.0, 100.0,
        500.01, 400.0, 0.0, 100.0, 100.0, 189.25, 1.0, 17.99, 2.00, 0.0, 148.76, 42.49, None, ""
    )]
    #[case(
        1334.26, 552.0, 1162.0, 0.0, 0.0, 10.0, 20.0, 0.0, 0.0, 0.0, 20.0, 12.0, 20.0, 10.0, 100.0,
        499.99, 400.0, 0.0, 100.0, 100.0, 189.25, 1.0, 17.99, 2.00, 0.0, 148.76, 42.49, None, ""
    )]
    #[case(
        1334.26, 552.0, 1162.0, 0.0, 0.0, 10.0, 20.0, 0.0, 0.0, 0.0, 20.0, 12.0, 20.0, 10.0, 100.0,
        500.0, 400.01, 0.0, 100.0, 100.0, 189.25, 1.0, 17.99, 2.00, 0.0, 148.76, 42.49, None, ""
    )]
    #[case(
        1334.26, 552.0, 1162.0, 0.0, 0.0, 10.0, 20.0, 0.0, 0.0, 0.0, 20.0, 12.0, 20.0, 10.0, 100.0,
        500.0, 399.99, 0.0, 100.0, 100.0, 189.25, 1.0, 17.99, 2.00, 0.0, 148.76, 42.49, None, ""
    )]
    #[case(
        1334.26, 552.0, 1162.0, 0.0, 0.0, 10.0, 20.0, 0.0, 0.0, 0.0, 20.0, 12.0, 20.0, 10.0, 100.0,
        500.0, 400.0, 0.01, 100.0, 100.01, 189.25, 1.0, 17.99, 2.00, 0.0, 148.76, 42.49, None, ""
    )]
    #[case(
        1334.26, 552.0, 1162.0, 0.0, 0.0, 10.0, 20.0, 0.0, 0.0, 0.0, 20.0, 12.0, 20.0, 10.0, 100.0,
        500.0, 400.0, 0.00, 100.01, 100.01, 189.25, 1.0, 17.99, 2.00, 0.0, 148.76, 42.49, None, ""
    )]
    #[case(
        1334.26, 552.0, 1162.0, 0.0, 0.0, 10.0, 20.0, 0.0, 0.0, 0.0, 20.0, 12.0, 20.0, 10.0, 100.0,
        500.0, 400.0, 0.0, 99.99, 99.99, 189.25, 1.0, 17.99, 2.00, 0.0, 148.76, 42.49, None, ""
    )]
    #[case(
        1334.26, 552.0, 1162.0, 0.0, 0.0, 10.0, 20.0, 0.0, 0.0, 0.0, 20.0, 12.0, 20.0, 10.0, 100.0,
        500.0, 400.0, 0.0, 100.0, 100.0, 189.25, 1.0, 17.99, 2.00, 0.0, 148.76, 42.48, None, ""
    )]
    #[case(
        1334.26, 552.0, 1162.0, 0.0, 0.0, 10.0, 20.0, 0.0, 0.0, 0.0, 20.0, 12.0, 20.0, 10.0, 100.0,
        500.0, 400.0, 0.0, 100.0, 100.0, 189.25, 1.0, 17.99, 2.00, 0.0, 148.76, 42.50, None, ""
    )]
    ...
    #[case(1334.26, 552.0, 1162.0, 0.0, 0.0, 10.0, 20.0, 0.0, 0.0, 0.0, 20.0, 12.0, 20.0, 10.0, 100.0, 500.0, 400.0, 0.0, 100.0, 100.0, 188.15, 1.0, 17.99,
        2.0, 0.0, 148.76, 42.49, Some(-1.1), "10920")]
    #[case(1334.26, 552.0, 1162.0, 0.0, 0.0, 10.0, 20.0, 0.0, 0.0, 0.0, 20.0, 12.0, 20.0, 10.0, 100.0, 500.0, 400.0, 0.0, 100.0, 100.0, 189.25, 0.5, 17.99,
