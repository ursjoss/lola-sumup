...
mod tests {
    ...
    #[case(
        ...
        1324.41, 17.84, 146.76, 42.49, None, ""
    )]
    // still valid, as we accept a deviation of 0.1/-0.1
    #[case(
        0.0, 0.0, 10.0, 0.0, 0.0, 0.0, 19.99, 12.0, 20.0, 100.0, 500.0, 400.0, 100.0, 189.25, 1.0,
        1324.41, 17.84, 146.76, 42.49, None, ""
    )]
    #[case(
        0.0, 0.0, 10.0, 0.0, 0.0, 0.0, 20.01, 12.0, 20.0, 100.0, 500.0, 400.0, 100.0, 189.25, 1.0,
        1324.41, 17.84, 146.76, 42.49, None, ""
    )]
    #[case(
    ...
    #[case(
        0.0, 0.0, 10.0, 0.0, 0.0, 0.0, 20.0, 12.0, 20.0, 100.0, 500.0, 400.0, 100.0, 189.25, 1.0,
        1324.41, 17.84, 146.76, 42.48, None, ""
    )]
    #[case(
        0.0, 0.0, 10.0, 0.0, 0.0, 0.0, 20.0, 12.0, 20.0, 100.0, 500.0, 400.0, 100.0, 189.25, 1.0,
        1324.41, 17.84, 146.76, 42.50, None, ""
    )]
    ...
    #[case(0.0, 0.0, 10.0, 0.0, 0.0, 0.0, 20.0, 12.0, 20.0, 100.0, 500.0, 400.0, 100.0, 188.15, 1.0, 1324.41, 17.84, 146.76, 42.49, Some(-1.1), "10920")]
    #[case(0.0, 0.0, 10.0, 0.0, 0.0, 0.0, 20.0, 12.0, 20.0, 100.0, 500.0, 400.0, 100.0, 189.25, 0.5, 1324.41, 17.84, 146.76, 42.49, Some(-0.5), "10920")]
    #[case(
        0.0,
        0.0,
        10.0,
    ...
    #[case(0.0, 0.0, 10.0, 0.0, 0.0, 0.0, 20.0, 12.0, 20.0, 100.0, 500.0, 400.0, 100.0, 189.25, 1.0, 1333.51, 17.84, 146.76, 42.49, Some(-9.1), "10920")]
    ...
    #[case(0.0, 0.0, 10.0, 0.0, 0.0, 0.0, 20.0, 12.0, 20.0, 100.0, 500.0, 400.0, 100.0, 189.25, 1.0, 1324.41, 17.84, 146.76, 42.51, Some(-0.02), "20051")]
    fn test_violations(
        #[case] cafe_cash: f64,
        #[case] verm_cash: f64,
        #[case] sofe_cash: f64,
