...
mod tests {
    ...
    fn test_gather_df_accounting() {
        ...
        let df_summary = df!(
            ...
            "Net Card LoLa" => &[1015.96],
            "Gross Card Total" => &[1223],
            "Total Commission" => &[18.29],
            "Net Card Total" => &[1204.71],
        ...
        let expected = df!(
            ...
            "10920/20051" => &[189.25],
            "10920/10910" => &[0.0],
            "Payment SumUp" => &[1205.71],
            "68450/10920" => &[Some(16.04)],
            "20051/10900" => &[145.76],
            "20051/30500" => &[42.49],
        )
        .expect("valid data frame")
    ...
    // fully valid case
    #[case(
        20.0, 12.0, 100.0, 500.0, 400.0, 189.25, 1.0, 1206.21, 16.04, 146.76, 42.49, None, ""
    )]
    // still valid, as we accept a deviation of 0.1/-0.1
    #[case(
        19.99, 12.0, 100.0, 500.0, 400.0, 189.25, 1.0, 1206.21, 16.04, 146.76, 42.49, None, ""
    )]
    #[case(
        20.01, 12.0, 100.0, 500.0, 400.0, 189.25, 1.0, 1206.21, 16.04, 146.76, 42.49, None, ""
    )]
    #[case(
        20.0, 12.01, 100.0, 500.0, 400.0, 189.25, 1.0, 1206.21, 16.04, 146.76, 42.49, None, ""
    )]
    #[case(
        20.0, 11.99, 100.0, 500.0, 400.0, 189.25, 1.0, 1206.21, 16.04, 146.76, 42.49, None, ""
    )]
    #[case(
        20.0, 12.0, 100.01, 500.0, 400.0, 189.25, 1.0, 1206.21, 16.04, 146.76, 42.49, None, ""
    )]
    #[case(
        20.0, 12.0, 99.99, 500.0, 400.0, 189.25, 1.0, 1206.21, 16.04, 146.76, 42.49, None, ""
    )]
    #[case(
        20.0, 12.0, 100.0, 500.01, 400.0, 189.25, 1.0, 1206.21, 16.04, 146.76, 42.49, None, ""
    )]
    #[case(
        20.0, 12.0, 100.0, 499.99, 400.0, 189.25, 1.0, 1206.21, 16.04, 146.76, 42.49, None, ""
    )]
    #[case(
        20.0, 12.0, 100.0, 500.0, 400.01, 189.25, 1.0, 1206.21, 16.04, 146.76, 42.49, None, ""
    )]
    #[case(
        20.0, 12.0, 100.0, 500.0, 399.99, 189.25, 1.0, 1206.21, 16.04, 146.76, 42.49, None, ""
    )]
    #[case(
        20.0, 12.0, 100.0, 500.0, 400.0, 189.25, 1.0, 1206.21, 16.04, 146.76, 42.48, None, ""
    )]
    #[case(
        20.0, 12.0, 100.0, 500.0, 400.0, 189.25, 1.0, 1206.21, 16.04, 146.76, 42.50, None, ""
    )]
    ...
    #[case(20.0, 12.0, 100.0, 500.0, 400.0, 188.15, 1.0, 1206.21, 16.04, 146.76, 42.49, Some(-1.1), "10920")]
    #[case(20.0, 12.0, 100.0, 500.0, 400.0, 189.25, 0.5, 1206.21, 16.04, 146.76, 42.49, Some(-0.5), "10920")]
    #[case(
        20.0,
        12.0,
        100.0,
    ...
    #[case(20.0, 12.0, 100.0, 500.0, 400.0, 189.25, 1.0, 1215.31, 16.04, 146.76, 42.49, Some(-9.1), "10920")]
    ...
    #[case(20.0, 12.0, 100.0, 500.0, 400.0, 189.25, 1.0, 1206.21, 16.04, 146.76, 42.51, Some(-0.02), "20051")]
    fn test_violations(
        #[case] cc: f64,
        #[case] vc: f64,
        #[case] dc: f64,
