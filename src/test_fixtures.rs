...
pub fn intermediate_df_01(sample_date: NaiveDate, sample_time: NaiveTime) -> DataFrame {
    df!(
        ...
        "Receipt Number" => &[AnyValue::Null, AnyValue::Null],
        ...
        "Price (Net)" => &[16.0, 1.0],
        "Tax" => &[AnyValue::Null, AnyValue::Null],
        "Tax rate" => &[AnyValue::Null, AnyValue::Null],
        "Transaction refunded" => &[AnyValue::Null, AnyValue::Null],
